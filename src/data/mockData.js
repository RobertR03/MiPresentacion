// Datos de ejemplo para usar mientras se configura la conexión con PlanetScale
...
export const skills = [
  ...
  { id: 7, name: "MongoDB", level: 75, category: "Backend" },
  { id: 8, name: "MySQL", level: 80, category: "Backend" },
